...
My heuristic evaluations of the mobile map applications will be based on the guidelines documents that correspond to the applications. I will examine Google Maps first.
]
The icons of the Google Maps mobile application comply with the Google Design Guidelines\cite{Google}: simple, modern, geometric in execution, and with rounded corners. Be that as it may, Google Maps completely fails to use any standard iOS icons. Though it is not required to use these provided iOS icons, the iOS Human Interface Guidelines state that it is "a good idea to use the built-in icons as much as possible because users already know what they mean".\cite{Apple}
...
\bibitem{Apple} \emph{iOS Human Interface Guidelines}, https://developer.apple.com/library/ios/documentation/userexperience.
\end{thebibliography}
%%%%%%%%%%%%% end %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
