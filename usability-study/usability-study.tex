...
\par
\noindent
This suggests that the icon on the top left-hand corner ---which happens to be the directions screen in this app--- is the most important. I would have to agree that getting directions is very important functionality, so it seems as if the app is complying to the guidelines. However, a couple of test subjects tried to click on the icon second from the right on the bottom for directions. It is possible that this guideline of important functionality being `elevated' may not be intuitive to all users.
\end{multicols}
\medskip
\medskip
\par
