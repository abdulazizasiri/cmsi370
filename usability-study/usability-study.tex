...
\vspace{-.6in}
\par
Average time for task \#1 on Apple Maps app: approx. \textbf{19 seconds}
\par
Average time for task \#1 on Google Maps app: approx. \textbf{21 seconds}
\end{center}
\par
\noindent
...
\vspace{-.6in}
\par
Average time for task \#2 on Apple Maps app: approx. \textbf{24 seconds}
\par
Average time for task \#2 on Google Maps app: approx. \textbf{21 seconds}
\end{center}
\par
\noindent
...
\vspace{-.4in}
\par
Average time for task \#3 on Apple Maps app: approx. \textbf{36 seconds}
\par
Average time for task \#3 on Google Maps app: approx. \textbf{17 seconds}
\end{center}
\par
\noindent
This task's results suggest that users are more efficient using Google Maps. 
