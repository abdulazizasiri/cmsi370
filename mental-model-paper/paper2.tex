...
\begin{abstract} % JD: My bad; this was the right way.
...
% JD: I won't change it for the rest of the document, but just note that you want your cites *before*
%     the periods of sentences.
...
\cite{Tinwala:2010:ETE:1868914.1868972,El-Glaly:2013:TTF:2460625.2460665}. % JD: etc.
% JD: A sentence like the above typically concludes with a list of citations---representing the
%     aforementioned "fair amount of previous work." :)  Then these citations are cherry-picked
%     and discussed in further detail..the way you do next.
...
% JD: Parentheticals like the one above also typically precede the period.
...
% JD: You don't do this very often, but have done it enough times to get noticed:
%     sometimes you quote your references directly, but the quote itself does not
%     seem particularly compelling.  i.e., You would have done just as well to
%     paraphrase the author.  The reason this is preferred is that it gives your
%     writing a more cohesive voice---yours.  Unless a quote has such compelling
%     word choice and phrasing that its point loses value when paraphrased, things
%     generally read more smoothly if you don't disrupt the flow with quotes.
%
%     And note that you are still citing your source, so the paraphrasing does not
%     constitute any form of unfair use.
...
% JD: Nicely done!  Please consider entering this in ULRA.  Additional figures might be
%     needed, I think, to communicate with a broader audience, but overall this is a
%     well-investigated, well-executed piece of work.
